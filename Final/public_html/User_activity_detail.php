...
<html>
        ...
        <form method="POST" action="payment.php">
                    <button name="payment" id="payment">Register Activity</button></form>
    
        <!-- <button onclick="document.getElementById('id01').style.display='block'" name="register_activity" id="register_activity" '>Register Activity</button>
        ...
        <link rel="stylesheet" href="login_style.css">
         ...
         <div id="id01" class="modal">
          ...
          <form class="modal-content" action= 'User_activity_detail.php' method="post">
            <div class="container">
              ...
              <div class="clearfix">
                ...
                <button type="submit" onclick="document.getElementById('id02').style.display='block'" class="login">Confirm and Pay</button>
              </div>
              <link rel="stylesheet" href="login_style.css">
              <link rel="stylesheet" type="text/css" href="login_style.css">
            </div>
