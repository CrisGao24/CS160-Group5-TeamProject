...
<html>
	...
	<body>
        ...
        <div class="row row-content align-items-center">
            <form class="col-12 col-sm-12 order-sm-last col-md-12" action='index.php' method="post" name="act">
...
function addVender()
{
    ...
    if (isset($_POST['vender_email']) && isset($_POST['vender_firstnm']) && isset($_POST['vender_lastnm']) && isset($_POST['vender_psw']))
    {
    	...
    	$query = "INSERT INTO Vender VALUES" .
    		"(NULL,'$vender_email','$vender_psw', '$vender_firstnm', '$vender_lastnm', 0, '$salt1', '$salt2', '$vender_hash',0)";
    	$result = $conn->query($query);
...
function addUser()
{
    ...
    if (isset($_POST['email']) && isset($_POST['firstnm']) && isset($_POST['lastnm']) && isset($_POST['psw']))
    {
    	...
    	$query = "INSERT INTO Users VALUES" .
    		"(NULL,'$uemail','$upsw', '$ufirstnm', '$ulastnm', 0, '$salt1', '$salt2', '$user_hash',0)";
    	$result = $conn->query($query);
    	if (!$result) echo "INSERT failed: $query<br>" . $conn->error . "<br><br>";
