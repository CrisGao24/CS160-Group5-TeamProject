	...
	<body>
        ...
        <div  class="bodycontent">
            ...
            <div class="container">
                ...
                <div><label style="color:#8A2BE2;text-align:center;"><h1>Users Information<br/></h1></label></div>
_End;
                ...
                echo<<<_e2
                  ...
                  <div>
                  <button type="button" onclick="document.getElementById('id08').style.display='block'" class="signupbtn">Lock User</button></div>
                  
                  <div>
                  <button type="button" onclick="document.getElementById('id09').style.display='block'" class="signupbtn">Unlock User</button></div>
                  
                  <div>
                  <button type="button" onclick="document.getElementById('id10').style.display='block'" class="signupbtn">Delete User</button></div>
                ...
                <div id="id06" class="modal">
                    ...
                    <form class="modal-content" action="user_manage.php" method="post" name="setPassword">
                        <div class="container">
                            <h1>Set Password</h1>
                ...
                <div id="id07" class="modal">
                    ...
                    <form class="modal-content" action="user_manage.php" method="post" name="setPoinst">
                        <div class="container">
                ...
                <div id="id08" class="modal">
                    ...
                    <form class="modal-content" action="user_manage.php" method="post" name="lockUser">
                        <div class="container">
                            <h1>Lock User</h1>
                            <p>Please fill in this form to lock user<p>
                            <hr>
                            <label for="userID3"><b>The userID for the person you want to lock</b></label>
                            <input type="text" placeholder="Enter userID" name="userID3" required>
                ...
                <div id="id09" class="modal">
                    ...
                    <form class="modal-content" action="user_manage.php" method="post" name="unlockUser">
                        <div class="container">
                            <h1>Unlock User</h1>
                            <p>Please fill in this form to unlock user<p>
                            <hr>
                            <label for="userID4"><b>The userID for the person you want to unlock</b></label>
                            <input type="text" placeholder="Enter userID" name="userID4" required>
                ...
                <div id="id10" class="modal">
                    ...
                    <form class="modal-content" action="user_manage.php" method="post" name="deleteUser">
                        <div class="container">
                            <h1>Delete User</h1>
                            <p>Please fill in this form to delete user<p>
                            <hr>
                            <label for="userID5"><b>The userID for the person you want to delete</b></label>
                            <input type="text" placeholder="Enter userID" name="userID5" required>
    ...
    if(isset($_POST['userID2']) && isset($_POST['user_points']) && isset($_POST['confirm_points'])){
        ...
        if($points != $RePoints)
            ...
            if(!$result)
                ...
                $query2 = "UPDATE Users SET Points = '$points' WHERE UserID = '$userID'";
    ...
    if(isset($_POST['userID1']) && isset($_POST['userPwd']) && isset($_POST['RePwd'])){
        ...
        if($pwd != $rePwd)
            ...
            if(!$result)
                ...
                $query2 = "UPDATE Users SET Password = '$pwd' WHERE UserID= '$userID'";
                $result2 = $conn->query($query2);
            }
        }
    }
...
function lockUser(){
    ...
    if(isset($_POST['userID3'])){
        ...
        if(!$result)
            ...
            $query2 = "UPDATE Users SET lockUser = 1 WHERE UserID= '$userID'";
            $result2 = $conn->query($query2);
        }
    }
...
function unlockUser(){
    ...
    if(isset($_POST['userID4'])){
        ...
        if(!$result)
            ...
            $query2 = "UPDATE Users SET lockUser = 0 WHERE UserID= '$userID'";
            $result2 = $conn->query($query2);
        }
    }
