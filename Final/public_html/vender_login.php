...
_End;
                    echo $_SESSION['Vender_Email'];
echo <<<_Endd
                    </label>
                    
                    <form method="POST" action="vender_info.php">
        ...
        <div class="row row-content align-items-center">
            <form class="col-12 col-sm-12 order-sm-last col-md-12" action='vender_login.php' method="post" name="act">
            ...
            for ($i = 0 ; $i < $rows ; ++$i)
            {
                ...
                else
                {
                    ...
                    echo "
                        <div class='row row-content align-items-center'>
                            <div class='col-12 col-sm-12 order-sm-last col-md-12'>
                                <form class='col-3 col-sm-3 order-sm-last col-md-3' action='vender_login.php' method='post' name='searchAct'>
    ...
    if(isset($_SESSION['number'])){
        for($i = 0; $i <= $_SESSION['number']; $i++){
            ...
            if(isset($_POST[$i])){
                ...
                header('location: Vender_activity_detail.php', true,  301 );  exit;
            }
