	    ...
	    <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="Navbar">
                    ...
                    <form method="POST" action="vender_login.php">
...
_e;
                ...
                <div id="id06" class="modal">
                    ...
                    <form class="modal-content" action="vender_info.php" method="post">
                        <div class="container">
...
{
    global $conn;
    if (isset($_POST['new_name']) && isset($_POST['new_type']) && isset($_POST['new_cost']) && isset($_POST['new_street']) && isset($_POST['new_city']) && isset($_POST['new_state']) &&isset($_POST['new_country']) && isset($_POST['new_zipcode']))
    {
        ...
        "(NULL, '$_SESSION[VenderID]','$new_name','$new_type', '$new_maxAge', '$new_minAge', '$new_cost')";
    	$result = $conn->query($query);
